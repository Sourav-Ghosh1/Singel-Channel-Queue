...
print("Customer.No. - InterArrival T.- A.T -  S.T - S T.B - Waiting T.in Queue  - S.T.E  - C. Spend T. in System - Server  Idle T.")
 
for i in range(n):
    if i == 0:
        print(  (i + 1, arrivalTime[i], serviceTime[i], SBT[i], waitingTime[i], SET[i], customerSpendInSystem[i]))
    else:
        print(
